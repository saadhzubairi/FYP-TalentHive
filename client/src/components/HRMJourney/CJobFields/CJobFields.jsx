...
function CJobFields(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const req = {
                jobPosting: `${job.jobTitle} ${job.location} ${job.requiremets} ${job.description} ${job.type}`,
                skills: job.skills
            }
            console.log(req)
            await axios.post('http://127.0.0.1:8000/jobScoringList/', req, {
